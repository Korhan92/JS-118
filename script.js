...
console.log(newCar.changeMod());

let newHonda1 = new newCar("Honda", "CRV", "2022", undefined, true)
newHonda1.updateYear();
//newHonda1.changeMod(); // static method objecte geçmez
...
// default export'u
import Person from "./person.js"  // aynı isimle
import Personal from "./person.js"  // veya farklı isimle alabilirsiniz


//isimle yapılan exportta
import {newValues, Staff} from "./person.js"; // aynı isimle çağırmalısınız, sırası önemli değil.